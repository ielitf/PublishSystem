...
public class PublishYetListAdapter extends MyBaseAdapter2<PublicListBean> {
    private LayoutInflater inflater;
    public PublishYetListAdapter(Context context, List<PublicListBean> data){
    	super(data,context);
